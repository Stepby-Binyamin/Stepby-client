...
export const AddWidget = () => {
    return (
        <div className={styles.addWidget}>
            ...
            <BtnIcon text={"העלאת קובץ / צילום"} icon={"/images/icon-btns/Upload.svg"} style={{ "margin-bottom": "15px" }} />
            ...
            <BtnIcon text={"תמונה"} icon={"/images/icon-btns/image.svg"} style={{ "margin-bottom": "15px" }} />
            <BtnIcon text={"PDF קובץ "} icon={"/images/icon-btns/filePDF.svg"} style={{ "margin-bottom": "15px" }} />
