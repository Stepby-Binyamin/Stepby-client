...
const MoreMenuTemplate = ({ style = {}, deleteProjectFunc, templateId, creatorIdPermissions, ...props }) => {
   ...
   return (
      <div className={styles.MoreMenuTemplate}>
         <div className={styles.btn}>
            <BtnIcon icon='/images/icons/duplicate.svg' text={language.DUPLICATE_TEMPLATE} onClick={duplicateTempFunc} />
         </div>
         ...
         {!(userData.permissions === "biz" && creatorIdPermissions === "admin") &&
            <div>
               <BtnIcon icon='/images/icons/delete.svg' text={language.DELETE_TEMPLATE} textColor="#EF0E0E" onClick={deleteProjectFunc} />
            </div>}
      </div>
   )
}
